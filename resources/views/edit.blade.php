                    ...
                    <section>
                        <header>
                            ...
                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                {{ __("Enter a quote from a book. Can't find what you're looking for?") }}
                                <a href="{{ route('manualAdd') }}" class="underline">Try it manually</a>
                            </p>
                        </header>
                        ...
                        <form method="post" action="{{ route('save') }}" class="mt-6 space-y-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="character" name="character" type="text"
                                    placeholder="i.e., Gandalf, Frodo, Sam..." class="mt-1 block w-full" autofocus
